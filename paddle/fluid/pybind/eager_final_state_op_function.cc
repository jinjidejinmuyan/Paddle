...
static PyObject *eager_final_state_api_bernoulli(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      auto NEW_x = egr::EagerAmpAutoCast("x", x, amp_dst_dtype, op_name, false);

      out = paddle::experimental::bernoulli(NEW_x);
    } else {
      out = paddle::experimental::bernoulli(x);
    }
...
static PyObject *eager_final_state_api_diag(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::diag_final_state_dygraph_function(
        x, offset, padding_value)) out =
        ::diag_final_state_dygraph_function(x, offset, padding_value);
...
static PyObject *eager_final_state_api_solve(PyObject *self,
                                             PyObject *args,
                                             PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "solve pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::solve_final_state_dygraph_function(x, y)) out =
        ::solve_final_state_dygraph_function(x, y);
...
static PyObject *eager_final_state_api_accuracy(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{x}, {indices}, {label}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_x = egr::EagerAmpAutoCast("x", x, amp_dst_dtype, op_name, false);
      auto NEW_indices = egr::EagerAmpAutoCast(
          "indices", indices, amp_dst_dtype, op_name, false);
      auto NEW_label =
          egr::EagerAmpAutoCast("label", label, amp_dst_dtype, op_name, false);

      out = paddle::experimental::accuracy(NEW_x, NEW_indices, NEW_label);
    } else {
      out = paddle::experimental::accuracy(x, indices, label);
    }
...
static PyObject *eager_final_state_api_adadelta(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      auto op_name = phi::TransToFluidOpName("adadelta");
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {
      ...
      auto NEW_param =
          egr::EagerAmpAutoCast("param", param, amp_dst_dtype, op_name, false);
      auto NEW_grad =
          egr::EagerAmpAutoCast("grad", grad, amp_dst_dtype, op_name, false);
      auto NEW_avg_squared_grad = egr::EagerAmpAutoCast(
          "avg_squared_grad", avg_squared_grad, amp_dst_dtype, op_name, false);
      auto NEW_avg_squared_update = egr::EagerAmpAutoCast("avg_squared_update",
                                                          avg_squared_update,
                                                          amp_dst_dtype,
                                                          op_name,
                                                          false);

      out = paddle::experimental::adadelta(NEW_param,
                                           NEW_grad,
                                           NEW_avg_squared_grad,
                                           NEW_avg_squared_update,
                                           rho,
                                           epsilon);
    } else {
      out = paddle::experimental::adadelta(
...
static PyObject *eager_final_state_api_adamax(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      auto op_name = phi::TransToFluidOpName("adamax");
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{param},
                                {grad},
                                {learning_rate},
                                {moment},
                                {inf_norm},
      ...
      auto NEW_grad =
          egr::EagerAmpAutoCast("grad", grad, amp_dst_dtype, op_name, false);
      auto NEW_learning_rate = egr::EagerAmpAutoCast(
          "learning_rate", learning_rate, amp_dst_dtype, op_name, false);
      auto NEW_moment = egr::EagerAmpAutoCast(
          "moment", moment, amp_dst_dtype, op_name, false);
      auto NEW_inf_norm = egr::EagerAmpAutoCast(
          "inf_norm", inf_norm, amp_dst_dtype, op_name, false);
      auto NEW_beta1_pow = egr::EagerAmpAutoCast(
          "beta1_pow", beta1_pow, amp_dst_dtype, op_name, false);

      out = paddle::experimental::adamax(NEW_param,
                                         NEW_grad,
                                         NEW_learning_rate,
                                         NEW_moment,
                                         NEW_inf_norm,
      ...
      out = paddle::experimental::adamax(param,
                                         grad,
                                         learning_rate,
                                         moment,
                                         inf_norm,
...
static PyObject *eager_final_state_api_all(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::all(NEW_x, dims, keep_dim);
    } else {
      out = paddle::experimental::all(x, dims, keep_dim);
    }
...
static PyObject *eager_final_state_api_allclose(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      auto NEW_x = egr::EagerAmpAutoCast("x", x, amp_dst_dtype, op_name, false);
      auto NEW_y = egr::EagerAmpAutoCast("y", y, amp_dst_dtype, op_name, false);

      out = paddle::experimental::allclose(NEW_x, NEW_y, rtol, atol, equal_nan);
    } else {
      out = paddle::experimental::allclose(x, y, rtol, atol, equal_nan);
    }
...
static PyObject *eager_final_state_api_angle(PyObject *self,
                                             PyObject *args,
                                             PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "angle pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::angle_final_state_dygraph_function(x)) out =
        ::angle_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_any(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::any(NEW_x, dims, keep_dim);
    } else {
      out = paddle::experimental::any(x, dims, keep_dim);
    }
...
static PyObject *eager_final_state_api_arange(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{start}, {end}, {step}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_start =
          egr::EagerAmpAutoCast("start", start, amp_dst_dtype, op_name, false);
      auto NEW_end =
          egr::EagerAmpAutoCast("end", end, amp_dst_dtype, op_name, false);
      auto NEW_step =
          egr::EagerAmpAutoCast("step", step, amp_dst_dtype, op_name, false);

      out = paddle::experimental::arange(
          NEW_start, NEW_end, NEW_step, dtype, place);
    } else {
      out = paddle::experimental::arange(start, end, step, dtype, place);
    }
...
static PyObject *eager_final_state_api_argmax(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::argmax(NEW_x, axis, keepdims, flatten, dtype);
    } else {
      out = paddle::experimental::argmax(x, axis, keepdims, flatten, dtype);
    }
...
static PyObject *eager_final_state_api_argmin(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::argmin(NEW_x, axis, keepdims, flatten, dtype);
    } else {
      out = paddle::experimental::argmin(x, axis, keepdims, flatten, dtype);
    }
...
static PyObject *eager_final_state_api_as_complex(PyObject *self,
                                                  PyObject *args,
                                                  PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::as_complex_final_state_dygraph_function(x)) out =
        ::as_complex_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_as_real(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::as_real_final_state_dygraph_function(x)) out =
        ::as_real_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_auc(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{x}, {label}, {stat_pos}, {stat_neg}};
      ...
      auto NEW_label =
          egr::EagerAmpAutoCast("label", label, amp_dst_dtype, op_name, false);
      auto NEW_stat_pos = egr::EagerAmpAutoCast(
          "stat_pos", stat_pos, amp_dst_dtype, op_name, false);
      auto NEW_stat_neg = egr::EagerAmpAutoCast(
          "stat_neg", stat_neg, amp_dst_dtype, op_name, false);

      out = paddle::experimental::auc(NEW_x,
                                      NEW_label,
                                      NEW_stat_pos,
                                      NEW_stat_neg,
                                      curve,
...
static PyObject *eager_final_state_api_bilinear_tensor_product(
  ...
  try {
    ...
    auto bias = GetOptionalTensorFromArgs(
        "bilinear_tensor_product", "bias", args, 3, true);
    ...
    // Call dygraph function
    decltype(::bilinear_tensor_product_final_state_dygraph_function(
        x, y, weight, bias)) out =
        ::bilinear_tensor_product_final_state_dygraph_function(
            x, y, weight, bias);
...
static PyObject *eager_final_state_api_bitwise_and(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::bitwise_and(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::bitwise_and(x, y);
    }
...
static PyObject *eager_final_state_api_bitwise_not(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::bitwise_not(NEW_x);
    } else {
      out = paddle::experimental::bitwise_not(x);
    }
...
static PyObject *eager_final_state_api_bitwise_or(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::bitwise_or(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::bitwise_or(x, y);
    }
...
static PyObject *eager_final_state_api_bitwise_xor(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::bitwise_xor(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::bitwise_xor(x, y);
    }
...
static PyObject *eager_final_state_api_cast(PyObject *self,
  ...
  try {
    ...
    // Parse Attributes if needed，解析额外参数，获取x的数据类型
    ...
    // 【待学习】C++11特性：decltype关键字；decltype做类型推导时不执行函数；decltype与auto的区别？
    // Call dygraph function
...
static PyObject *eager_final_state_api_clip_by_norm(PyObject *self,
                                                    PyObject *args,
                                                    PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    decltype(paddle::experimental::clip_by_norm(x, max_norm)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::clip_by_norm(NEW_x, max_norm);
    } else {
      out = paddle::experimental::clip_by_norm(x, max_norm);
    }
...
static PyObject *eager_final_state_api_complex(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::complex_final_state_dygraph_function(x, y)) out =
        ::complex_final_state_dygraph_function(x, y);
...
static PyObject *eager_final_state_api_copy_to(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::copy_to(NEW_x, place, blocking);
    } else {
      out = paddle::experimental::copy_to(x, place, blocking);
    }
...
static PyObject *eager_final_state_api_diag_embed(PyObject *self,
                                                  PyObject *args,
                                                  PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    decltype(paddle::experimental::diag_embed(x, offset, dim1, dim2)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::diag_embed(NEW_x, offset, dim1, dim2);
    } else {
      out = paddle::experimental::diag_embed(x, offset, dim1, dim2);
    }
...
static PyObject *eager_final_state_api_eigvals(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    decltype(paddle::experimental::eigvals(x)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::eigvals(NEW_x);
    } else {
      out = paddle::experimental::eigvals(x);
    }
...
static PyObject *eager_final_state_api_empty_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::empty_like(NEW_x, dtype, place);
    } else {
      out = paddle::experimental::empty_like(x, dtype, place);
    }
...
static PyObject *eager_final_state_api_equal(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::equal(NEW_x, NEW_y, axis);
    } else {
      out = paddle::experimental::equal(x, y, axis);
    }
...
static PyObject *eager_final_state_api_equal_all(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::equal_all(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::equal_all(x, y);
    }
...
static PyObject *eager_final_state_api_exponential_(PyObject *self,
                                                    PyObject *args,
                                                    PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "exponential_ pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::exponential__final_state_dygraph_function(x, lambda)) out =
        ::exponential__final_state_dygraph_function(x, lambda);
...
static PyObject *eager_final_state_api_floor_divide(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::floor_divide(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::floor_divide(x, y);
    }
...
static PyObject *eager_final_state_api_full_batch_size_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{input}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_input =
          egr::EagerAmpAutoCast("input", input, amp_dst_dtype, op_name, false);

      out = paddle::experimental::full_batch_size_like(
          NEW_input, shape, dtype, value, input_dim_idx, output_dim_idx, place);
    } else {
      out = paddle::experimental::full_batch_size_like(
...
static PyObject *eager_final_state_api_full_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::full_like(NEW_x, value, dtype, place);
    } else {
      out = paddle::experimental::full_like(x, value, dtype, place);
    }
...
static PyObject *eager_final_state_api_gather_tree(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{ids}, {parents}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_ids =
          egr::EagerAmpAutoCast("ids", ids, amp_dst_dtype, op_name, false);
      auto NEW_parents = egr::EagerAmpAutoCast(
          "parents", parents, amp_dst_dtype, op_name, false);

      out = paddle::experimental::gather_tree(NEW_ids, NEW_parents);
    } else {
      out = paddle::experimental::gather_tree(ids, parents);
    }
...
static PyObject *eager_final_state_api_greater_equal(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::greater_equal(NEW_x, NEW_y, axis);
    } else {
      out = paddle::experimental::greater_equal(x, y, axis);
    }
...
static PyObject *eager_final_state_api_greater_than(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::greater_than(NEW_x, NEW_y, axis);
    } else {
      out = paddle::experimental::greater_than(x, y, axis);
    }
...
static PyObject *eager_final_state_api_grid_sample(PyObject *self,
                                                   PyObject *args,
                                                   PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "grid_sample pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::grid_sample_final_state_dygraph_function(
        x, grid, mode, padding_mode, align_corners)) out =
        ::grid_sample_final_state_dygraph_function(
...
static PyObject *eager_final_state_api_histogram(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::histogram(NEW_x, bins, min, max);
    } else {
      out = paddle::experimental::histogram(x, bins, min, max);
    }
...
static PyObject *eager_final_state_api_increment(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::increment(NEW_x, value);
    } else {
      out = paddle::experimental::increment(x, value);
    }
...
static PyObject *eager_final_state_api_inverse(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::inverse_final_state_dygraph_function(x)) out =
        ::inverse_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_is_empty(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::is_empty(NEW_x);
    } else {
      out = paddle::experimental::is_empty(x);
    }
...
static PyObject *eager_final_state_api_isclose(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::isclose(NEW_x, NEW_y, rtol, atol, equal_nan);
    } else {
      out = paddle::experimental::isclose(x, y, rtol, atol, equal_nan);
    }
...
static PyObject *eager_final_state_api_isfinite(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::isfinite(NEW_x);
    } else {
      out = paddle::experimental::isfinite(x);
    }
...
static PyObject *eager_final_state_api_isinf(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::isinf(NEW_x);
    } else {
      out = paddle::experimental::isinf(x);
    }
...
static PyObject *eager_final_state_api_isnan(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::isnan(NEW_x);
    } else {
      out = paddle::experimental::isnan(x);
    }
...
static PyObject *eager_final_state_api_less_equal(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::less_equal(NEW_x, NEW_y, axis);
    } else {
      out = paddle::experimental::less_equal(x, y, axis);
    }
...
static PyObject *eager_final_state_api_less_than(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::less_than(NEW_x, NEW_y, axis);
    } else {
      out = paddle::experimental::less_than(x, y, axis);
    }
...
static PyObject *eager_final_state_api_linspace(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{start}, {stop}, {number}};
      ...
      auto NEW_start =
          egr::EagerAmpAutoCast("start", start, amp_dst_dtype, op_name, false);
      auto NEW_stop =
          egr::EagerAmpAutoCast("stop", stop, amp_dst_dtype, op_name, false);
      auto NEW_number = egr::EagerAmpAutoCast(
          "number", number, amp_dst_dtype, op_name, false);

      out = paddle::experimental::linspace(
          NEW_start, NEW_stop, NEW_number, dtype);
    } else {
      out = paddle::experimental::linspace(start, stop, number, dtype);
    }
...
static PyObject *eager_final_state_api_logical_and(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::logical_and(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::logical_and(x, y);
    }
...
static PyObject *eager_final_state_api_logical_not(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::logical_not(NEW_x);
    } else {
      out = paddle::experimental::logical_not(x);
    }
...
static PyObject *eager_final_state_api_logical_or(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::logical_or(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::logical_or(x, y);
    }
...
static PyObject *eager_final_state_api_logical_xor(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::logical_xor(NEW_x, NEW_y);
    } else {
      out = paddle::experimental::logical_xor(x, y);
    }
...
static PyObject *eager_final_state_api_matrix_rank(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::matrix_rank(
          NEW_x, tol, use_default_tol, hermitian);
    } else {
      out =
...
static PyObject *eager_final_state_api_matrix_rank_tol(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{x}, {atol_tensor}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_x = egr::EagerAmpAutoCast("x", x, amp_dst_dtype, op_name, false);
      auto NEW_atol_tensor = egr::EagerAmpAutoCast(
          "atol_tensor", atol_tensor, amp_dst_dtype, op_name, false);

      out = paddle::experimental::matrix_rank_tol(
          NEW_x, NEW_atol_tensor, use_default_tol, hermitian);
    } else {
      out = paddle::experimental::matrix_rank_tol(
...
static PyObject *eager_final_state_api_multinomial(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::multinomial(NEW_x, num_samples, replacement);
    } else {
      out = paddle::experimental::multinomial(x, num_samples, replacement);
    }
...
static PyObject *eager_final_state_api_not_equal(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::not_equal(NEW_x, NEW_y, axis);
    } else {
      out = paddle::experimental::not_equal(x, y, axis);
    }
...
static PyObject *eager_final_state_api_one_hot(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::one_hot(NEW_x, num_classes);
    } else {
      out = paddle::experimental::one_hot(x, num_classes);
    }
...
static PyObject *eager_final_state_api_ones_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::ones_like(NEW_x, dtype, place);
    } else {
      out = paddle::experimental::ones_like(x, dtype, place);
    }
...
static PyObject *eager_final_state_api_qr(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::qr(NEW_x, mode);
    } else {
      out = paddle::experimental::qr(x, mode);
    }
...
static PyObject *eager_final_state_api_searchsorted(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{sorted_sequence}, {value}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_sorted_sequence = egr::EagerAmpAutoCast(
          "sorted_sequence", sorted_sequence, amp_dst_dtype, op_name, false);
      auto NEW_value =
          egr::EagerAmpAutoCast("value", value, amp_dst_dtype, op_name, false);

      out = paddle::experimental::searchsorted(
          NEW_sorted_sequence, NEW_value, out_int32, right);
    } else {
      out = paddle::experimental::searchsorted(
...
static PyObject *eager_final_state_api_shape(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::shape(NEW_input);
    } else {
      out = paddle::experimental::shape(input);
    }
...
static PyObject *eager_final_state_api_shard_index(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{in}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_in =
          egr::EagerAmpAutoCast("in", in, amp_dst_dtype, op_name, false);

      out = paddle::experimental::shard_index(
          NEW_in, index_num, nshards, shard_id, ignore_value);
    } else {
      out = paddle::experimental::shard_index(
...
static PyObject *eager_final_state_api_sign(PyObject *self,
  ...
  try {
    ...
    decltype(paddle::experimental::sign(x)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::sign(NEW_x);
    } else {
      out = paddle::experimental::sign(x);
    }
...
static PyObject *eager_final_state_api_size(PyObject *self,
  ...
  try {
    ...
    decltype(paddle::experimental::size(x)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      auto op_name = phi::TransToFluidOpName("size");
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{x}};
      ...
      out = paddle::experimental::size(NEW_x);
    } else {
      out = paddle::experimental::size(x);
    }
...
static PyObject *eager_final_state_api_softsign(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::softsign_final_state_dygraph_function(x)) out =
        ::softsign_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_squared_l2_norm(PyObject *self,
                                                       PyObject *args,
                                                       PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::squared_l2_norm_final_state_dygraph_function(x)) out =
        ::squared_l2_norm_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_sync_batch_norm(PyObject *self,
                                                       PyObject *args,
                                                       PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: sync_batch_norm";
    ...
    // Parse Attributes if needed
    PyObject *momentum_obj = PyTuple_GET_ITEM(args, 5);
    float momentum = CastPyArg2Float(momentum_obj, "sync_batch_norm", 5);
    PyObject *epsilon_obj = PyTuple_GET_ITEM(args, 6);
    float epsilon = CastPyArg2Float(epsilon_obj, "sync_batch_norm", 6);
    PyObject *data_layout_obj = PyTuple_GET_ITEM(args, 7);
    std::string data_layout =
        CastPyArg2String(data_layout_obj, "sync_batch_norm", 7);
    PyObject *is_test_obj = PyTuple_GET_ITEM(args, 8);
    bool is_test = CastPyArg2Boolean(is_test_obj, "sync_batch_norm", 8);
    PyObject *use_global_stats_obj = PyTuple_GET_ITEM(args, 9);
    bool use_global_stats =
        CastPyArg2Boolean(use_global_stats_obj, "sync_batch_norm", 9);
    PyObject *trainable_statistics_obj = PyTuple_GET_ITEM(args, 10);
    bool trainable_statistics =
        CastPyArg2Boolean(trainable_statistics_obj, "sync_batch_norm", 10);
    PyObject *fuse_with_relu_obj = PyTuple_GET_ITEM(args, 11);
    bool fuse_with_relu =
        CastPyArg2Boolean(fuse_with_relu_obj, "sync_batch_norm", 11);
    ...
    // Call dygraph function
    decltype(::sync_batch_norm_final_state_dygraph_function(
        x,
        scale,
        bias,
        mean,
        ...
        trainable_statistics,
        fuse_with_relu)) out =
        ::sync_batch_norm_final_state_dygraph_function(x,
                                                       scale,
                                                       bias,
                                                       mean,
                                                       variance,
...
static PyObject *eager_final_state_api_temporal_shift(PyObject *self,
                                                      PyObject *args,
                                                      PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    std::string data_format_str =
        CastPyArg2String(data_format_str_obj, "temporal_shift", 3);
    ...
    // Call dygraph function
    decltype(::temporal_shift_final_state_dygraph_function(
        x, seg_num, shift_ratio, data_format_str)) out =
        ::temporal_shift_final_state_dygraph_function(
            x, seg_num, shift_ratio, data_format_str);
...
static PyObject *eager_final_state_api_unique(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::unique(
          NEW_x, return_index, return_inverse, return_counts, axis, dtype);
    } else {
      out = paddle::experimental::unique(
...
static PyObject *eager_final_state_api_unique_consecutive(PyObject *self,
                                                          PyObject *args,
                                                          PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    decltype(paddle::experimental::unique_consecutive(
        x, return_inverse, return_counts, axis, dtype)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::unique_consecutive(
          NEW_x, return_inverse, return_counts, axis, dtype);
    } else {
      out = paddle::experimental::unique_consecutive(
...
static PyObject *eager_final_state_api_viterbi_decode(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{input}, {transition}, {length}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_input =
          egr::EagerAmpAutoCast("input", input, amp_dst_dtype, op_name, false);
      auto NEW_transition = egr::EagerAmpAutoCast(
          "transition", transition, amp_dst_dtype, op_name, false);
      auto NEW_length = egr::EagerAmpAutoCast(
          "length", length, amp_dst_dtype, op_name, false);

      out = paddle::experimental::viterbi_decode(
          NEW_input, NEW_transition, NEW_length, include_bos_eos_tag);
    } else {
      out = paddle::experimental::viterbi_decode(
...
static PyObject *eager_final_state_api_where_index(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      auto op_name = phi::TransToFluidOpName("where_index");
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{condition}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_condition = egr::EagerAmpAutoCast(
          "condition", condition, amp_dst_dtype, op_name, false);

      out = paddle::experimental::where_index(NEW_condition);
    } else {
      out = paddle::experimental::where_index(condition);
    }
...
static PyObject *eager_final_state_api_yolo_box(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{x}, {img_size}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_x = egr::EagerAmpAutoCast("x", x, amp_dst_dtype, op_name, false);
      auto NEW_img_size = egr::EagerAmpAutoCast(
          "img_size", img_size, amp_dst_dtype, op_name, false);

      out = paddle::experimental::yolo_box(NEW_x,
                                           NEW_img_size,
                                           anchors,
                                           class_num,
                                           conf_thresh,
      ...
      out = paddle::experimental::yolo_box(x,
                                           img_size,
                                           anchors,
                                           class_num,
                                           conf_thresh,
...
static PyObject *eager_final_state_api_zeros_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::zeros_like(NEW_x, dtype, place);
    } else {
      out = paddle::experimental::zeros_like(x, dtype, place);
    }
...
static PyObject *eager_final_state_api_eig(PyObject *self,
                                           PyObject *args,
                                           PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "eig pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::eig_final_state_dygraph_function(x)) out =
        ::eig_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_abs(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::abs_final_state_dygraph_function(x)) out =
        ::sparse::abs_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_acos(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::acos_final_state_dygraph_function(x)) out =
        ::sparse::acos_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_acosh(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::acosh_final_state_dygraph_function(x)) out =
        ::sparse::acosh_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_asin(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::asin_final_state_dygraph_function(x)) out =
        ::sparse::asin_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_asinh(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::asinh_final_state_dygraph_function(x)) out =
        ::sparse::asinh_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_atan(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::atan_final_state_dygraph_function(x)) out =
        ::sparse::atan_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_atanh(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::atanh_final_state_dygraph_function(x)) out =
        ::sparse::atanh_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_cast(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::cast_final_state_dygraph_function(
        x, index_dtype, value_dtype)) out =
        ::sparse::cast_final_state_dygraph_function(
            x, index_dtype, value_dtype);
...
static PyObject *eager_final_state_api_divide_scalar(PyObject *self,
                                                     PyObject *args,
                                                     PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "divide_scalar pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::divide_scalar_final_state_dygraph_function(x,
                                                                  scalar)) out =
        ::sparse::divide_scalar_final_state_dygraph_function(x, scalar);
...
static PyObject *eager_final_state_api_expm1(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::expm1_final_state_dygraph_function(x)) out =
        ::sparse::expm1_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_leaky_relu(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::leaky_relu_final_state_dygraph_function(x, alpha)) out =
        ::sparse::leaky_relu_final_state_dygraph_function(x, alpha);
...
static PyObject *eager_final_state_api_log1p(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::log1p_final_state_dygraph_function(x)) out =
        ::sparse::log1p_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_pow(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::pow_final_state_dygraph_function(x, factor)) out =
        ::sparse::pow_final_state_dygraph_function(x, factor);
...
static PyObject *eager_final_state_api_relu6(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::relu6_final_state_dygraph_function(x, threshold)) out =
        ::sparse::relu6_final_state_dygraph_function(x, threshold);
...
static PyObject *eager_final_state_api_scale(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::scale_final_state_dygraph_function(
        x, scale, bias, bias_after_scale)) out =
        ::sparse::scale_final_state_dygraph_function(
...
static PyObject *eager_final_state_api_sinh(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::sinh_final_state_dygraph_function(x)) out =
        ::sparse::sinh_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_square(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::square_final_state_dygraph_function(x)) out =
        ::sparse::square_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_tan(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::tan_final_state_dygraph_function(x)) out =
        ::sparse::tan_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_to_dense(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::sparse::to_dense(NEW_x);
    } else {
      out = paddle::experimental::sparse::to_dense(x);
    }
...
static PyObject *eager_final_state_api_to_sparse_coo(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::sparse::to_sparse_coo(NEW_x, sparse_dim);
    } else {
      out = paddle::experimental::sparse::to_sparse_coo(x, sparse_dim);
    }
...
static PyObject *eager_final_state_api_to_sparse_csr(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::sparse::to_sparse_csr(NEW_x);
    } else {
      out = paddle::experimental::sparse::to_sparse_csr(x);
    }
...
static PyObject *eager_final_state_api_addmm(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::addmm_final_state_dygraph_function(
        input, x, y, alpha, beta)) out =
        ::sparse::addmm_final_state_dygraph_function(input, x, y, alpha, beta);
...
static PyObject *eager_final_state_api_coalesce(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "coalesce pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    decltype(paddle::experimental::sparse::coalesce(x)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::sparse::coalesce(NEW_x);
    } else {
      out = paddle::experimental::sparse::coalesce(x);
    }
...
static PyObject *eager_final_state_api_full_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::sparse::full_like(NEW_x, value, dtype);
    } else {
      out = paddle::experimental::sparse::full_like(x, value, dtype);
    }
...
static PyObject *eager_final_state_api_empty_like(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::strings::empty_like(NEW_x, place);
    } else {
      out = paddle::experimental::strings::empty_like(x, place);
    }
...
static PyObject *eager_final_state_api_lower(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::strings::lower(NEW_x, use_utf8_encoding);
    } else {
      out = paddle::experimental::strings::lower(x, use_utf8_encoding);
    }
...
static PyObject *eager_final_state_api_upper(PyObject *self,
  ...
  try {
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      out = paddle::experimental::strings::upper(NEW_x, use_utf8_encoding);
    } else {
      out = paddle::experimental::strings::upper(x, use_utf8_encoding);
    }
...
static PyMethodDef EagerFinalStateMethods[] = {
    ...
    {"final_state_solve",
     (PyCFunction)(void (*)(void))eager_final_state_api_solve,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_angle",
     (PyCFunction)(void (*)(void))eager_final_state_api_angle,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_as_complex",
     (PyCFunction)(void (*)(void))eager_final_state_api_as_complex,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_as_real",
     (PyCFunction)(void (*)(void))eager_final_state_api_as_real,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_bilinear_tensor_product",
     (PyCFunction)(void (*)(void))eager_final_state_api_bilinear_tensor_product,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_clip_by_norm",
     (PyCFunction)(void (*)(void))eager_final_state_api_clip_by_norm,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_complex",
     (PyCFunction)(void (*)(void))eager_final_state_api_complex,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_diag_embed",
     (PyCFunction)(void (*)(void))eager_final_state_api_diag_embed,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_eigvals",
     (PyCFunction)(void (*)(void))eager_final_state_api_eigvals,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_exponential_",
     (PyCFunction)(void (*)(void))eager_final_state_api_exponential_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_grid_sample",
     (PyCFunction)(void (*)(void))eager_final_state_api_grid_sample,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_inverse",
     (PyCFunction)(void (*)(void))eager_final_state_api_inverse,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_softsign",
     (PyCFunction)(void (*)(void))eager_final_state_api_softsign,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_squared_l2_norm",
     (PyCFunction)(void (*)(void))eager_final_state_api_squared_l2_norm,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_sync_batch_norm",
     (PyCFunction)(void (*)(void))eager_final_state_api_sync_batch_norm,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_temporal_shift",
     (PyCFunction)(void (*)(void))eager_final_state_api_temporal_shift,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_unique_consecutive",
     (PyCFunction)(void (*)(void))eager_final_state_api_unique_consecutive,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_eig",
     (PyCFunction)(void (*)(void))eager_final_state_api_eig,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_sparse_abs",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_abs,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for abs in dygraph."}

    ,

    {"final_state_sparse_acos",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_acos,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for acos in dygraph."}

    ,

    {"final_state_sparse_acosh",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_acosh,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for acosh in dygraph."}
    ...
    {"final_state_sparse_asin",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_asin,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for asin in dygraph."}

    ,

    {"final_state_sparse_asinh",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_asinh,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for asinh in dygraph."}

    ,

    {"final_state_sparse_atan",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_atan,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for atan in dygraph."}

    ,

    {"final_state_sparse_atanh",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_atanh,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for atanh in dygraph."}
    ...
    {"final_state_sparse_cast",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_cast,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for cast in dygraph."}
    ...
    {"final_state_sparse_divide_scalar",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_divide_scalar,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_sparse_expm1",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_expm1,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for expm1 in dygraph."}
    ...
    {"final_state_sparse_leaky_relu",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_leaky_relu,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for leaky_relu in dygraph."}

    ,

    {"final_state_sparse_log1p",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_log1p,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for log1p in dygraph."}
    ...
    {"final_state_sparse_pow",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_pow,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for pow in dygraph."}
    ...
    {"final_state_sparse_relu6",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_relu6,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for relu6 in dygraph."}
    ...
    {"final_state_sparse_scale",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_scale,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for scale in dygraph."}
    ...
    {"final_state_sparse_sinh",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_sinh,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for sinh in dygraph."}
    ...
    {"final_state_sparse_square",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_square,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for square in dygraph."}
    ...
    {"final_state_sparse_tan",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_tan,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for tan in dygraph."}
    ...
    {"final_state_sparse_addmm",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_addmm,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for addmm in dygraph."}
    ...
    {"final_state_sparse_coalesce",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_coalesce,
     METH_VARARGS | METH_KEYWORDS,
